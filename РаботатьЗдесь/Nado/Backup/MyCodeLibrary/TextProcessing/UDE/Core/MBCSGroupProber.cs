...
namespace MyCodeLibrary.TextProcessing.UDE.Core
{
    ...
    public class MBCSGroupProber : CharsetProber
    {
        ...
        private readonly static string[] ProberName = { "UTF8", "SJIS", "EUCJP", "GB18030", "EUCKR", "Big5", "EUCTW" };//компактные названия только для вывода на экран консоли в DumpStatus()
